"""Backtest NBA v2 bet policies on walk-forward OOS predictions.
...
data/models/nba_v2/bet_policy.json.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Backtest NBA v2 bet policies")
