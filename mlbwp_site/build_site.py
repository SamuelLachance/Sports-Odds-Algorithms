        ...
        <div class="panel"><h3>Our projection</h3>
          ...
          <div class="sub" style="margin-top:8px;color:var(--faint)">
            ${g.lineup_source==="official"
              ...
              ? "Projected lineup &mdash; the injury-aware likely nine (most-frequent recent starters still on the active roster, IL'd players excluded). The full model runs on it and upgrades automatically when the official lineup posts."
