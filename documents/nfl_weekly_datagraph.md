...
| data/nfl_qb2026.json | none — ad-hoc from depth_charts snapshot dt=2026-07-23 (commit 4b9e570) | nfl_season_serve.py:137,609 | frozen duplicate of what nfl_lineups.py:132-135 already derives live; goes stale as QB battles resolve |
...
| 5 | Regenerate nfl_qb2026.json — or retire it in favor of nfl_lineups.py's live QB1 derivation (:132-135), removing the frozen duplicate path | trivial; prefer retirement |
...
- data/nfl_qb2026.json — frozen at 2026-07-23 snapshot, no generator; goes stale silently.
